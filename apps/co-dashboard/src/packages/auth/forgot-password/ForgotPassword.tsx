...
// Components
import { Typography, Stack, Avatar, TextField, Card } from '@mui/material';
      ...
      <Stack direction="column" spacing={6}>
        ...
        <Stack direction="column" spacing={2}>
          <Typography variant="h3" align="center">
            {tAuth('forgotPasswordSuccessTitle')}
          </Typography>
          <Typography variant="body1" align="center">
            {tAuth('forgotPasswordSuccessDescription')}
          </Typography>
        </Stack>
        <Stack direction="column" spacing={1}>
          ...
          {resend && countdown === 0 ? (
            ...
            <Typography variant="subtitle2" align="center">
              Send verification email again in ({displayCountdown})
            </Typography>
          )}
        </Stack>
        {isLimit && (
          ...
          >
            <Typography>
              You have exceeded the limit of re-send the verification email.
              Please wait for 1 hour to send the verification email again.{' '}
            </Typography>
          </Card>
        )}
      </Stack>
