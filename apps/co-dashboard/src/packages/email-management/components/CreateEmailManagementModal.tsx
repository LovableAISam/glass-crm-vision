...
export type CreateEmailManagementModalProps = {
      ...
      <DialogTitle>
        ...
        >
          <Typography variant="h5">
            {isUpdate
              ? tEmailContent('modalUpdateTitle')
              : tEmailContent('modalCreateTitle')}
          </Typography>
            ...
            <Grid container spacing={2}>
              <Grid item md={12} xs={12}>
                <Typography variant="subtitle2" gutterBottom>
                  {tEmailContent('formEmailSubject')}
                </Typography>
                <TextField
                  {...fieldSubject}
                  fullWidth
              ...
              <Grid item md={12} xs={12}>
                <Typography variant="subtitle2" gutterBottom>
                  {tEmailContent('formEmailContent')}
                </Typography>
                <Card
                  elevation={0}
                  sx={{
                ...
                >
                  <Typography variant="body2">
                      ...
                      <li>
                        <div
                          dangerouslySetInnerHTML={{
                            __html: tEmailContent(
                              'infoEmailContentDescription',
                            ),
                          }}
                        />
                      </li>
                    ...
                    >
                      {tEmailContent('infoEmailContentTitle')}
                    </Typography>
              ...
              <Grid item md={12} xs={12}>
                <Typography variant="subtitle2" gutterBottom>
                  {tEmailContent('formEmailContentType')}
                </Typography>
                <Autocomplete
              ...
              <Stack sx={{ height: '100%' }}>
                ...
                <Card sx={{ p: 3, borderRadius: 4, flexGrow: 1 }}>
                  <Stack direction="column" spacing={2}>
                    ...
                    >
                      {getValues('subject') ||
                        tEmailContent('placeholderEmailSubject')}
                    </Typography>
                    <div
        ...
        >
          {isUpdate && (
            <Stack direction="row" spacing={2} display="none">
              <Button
                variant="text"
                data-testid="buttonActiveDeactive"
                startIcon={
              ...
              >
                {getValues('isActive')
                  ? tEmailContent('actionDectivate')
                  : tEmailContent('actionActivate')}
              </Button>
              <Box>
