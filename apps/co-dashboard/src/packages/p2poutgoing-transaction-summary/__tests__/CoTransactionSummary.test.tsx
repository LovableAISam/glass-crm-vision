...
const renderHookWithQueryProvider = <P, R>(
  hook: (props: P) => R,
...
const renderUseMemberSummaryList = () => {
  return renderHookWithQueryProvider(() => {
...
describe('CO Transaction Summary With Loading', () => {
  test('renders a loading state', () => {
    ...
    const pageTitle = getByText('pageTitleTransactionSummary');
