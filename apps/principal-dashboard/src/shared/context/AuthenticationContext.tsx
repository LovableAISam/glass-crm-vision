...
const AuthenticationDispatch = React.createContext<React.Dispatch<AuthenticationAction>>(null!);
...
function specReducer(state: AuthenticationData, action: AuthenticationAction): AuthenticationData {
  switch (action.type) {
    case 'do-login':
