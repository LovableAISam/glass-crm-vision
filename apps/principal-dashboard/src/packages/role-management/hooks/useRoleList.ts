...
// Hooks & Utils
import { useRoleListFetcher } from "@woi/service/principal";
...
import { RoleData, RoleListRequest } from "@woi/service/principal/idp/role/roleList";
...
function useRoleList() {
  ...
  const {
    ...
    async () => await useRoleListFetcher(baseUrl, rolePayload),
    {
