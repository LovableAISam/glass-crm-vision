...
const CreateSystemParameterModal = (props: CreateSystemParameterModalProps) => {
  ...
  const handleSave = () => {
    enqueueSnackbar(tCommon('successAdd', { text: 'System Parameter' }), {
      variant: 'success',
    });
    onHide();
  }
    ...
    >
      <DialogTitle>
        <Stack direction="row" justifyContent="space-between" alignItems="center">
          <Typography variant="h5">Add System Parameter</Typography>
      ...
      <DialogContent>
        <Grid container spacing={2} sx={{ pt: 1 }}>
          <Grid item md={12} xs={12}>
            <Typography variant="subtitle2" gutterBottom>System Parameter Code</Typography>
            <TextField
              fullWidth
              placeholder="type system parameter code"
              sx={{
          ...
          <Grid item md={12} xs={12}>
            <Typography variant="subtitle2" gutterBottom>System Parameter Value</Typography>
            <TextField
              fullWidth
              placeholder="type system parameter value"
              sx={{
                '& .MuiOutlinedInput-root': {
                  borderRadius: 3
                }
