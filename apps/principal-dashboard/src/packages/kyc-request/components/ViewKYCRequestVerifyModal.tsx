...
import { KycPremiumMemberStatus } from '@woi/service/principal/kyc/premiumMember/premiumMemberHistoryList';
        ...
        <Grid container spacing={2} sx={{ pt: 1 }}>
          <Grid item md={12} xs={12}>
            <Stack direction="column" spacing={1}>
              <Typography variant="subtitle2">{tKYC('verificationTitle')}</Typography>
              <FormControl
                component="fieldset"
                variant="standard"
                sx={{ width: '100%' }}
              >
                ...
                >
                  <FormControlLabel
                    value={'PREMIUM' as KycPremiumMemberStatus}
                    control={<Radio />}
          ...
          <Grid item md={12} xs={12}>
            ...
            >
              <Typography variant="body2">
                <div dangerouslySetInnerHTML={{ __html: tKYC('verificationInfo') }} />
              </Typography>
            </Card>
          </Grid>
          <Grid item md={12} xs={12}>
            <Stack direction="column" spacing={1}>
              ...
              <TextField
                {...fieldReason}
                fullWidth
                placeholder={tForm('placeholderSelect', { fieldName: 'reason of KYC approval/rejection' })}
                sx={{
