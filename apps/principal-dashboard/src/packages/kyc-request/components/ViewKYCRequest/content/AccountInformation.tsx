...
import { DateConvert, reverseDirection } from '@woi/core';
...
function AccountInformation(_: ViewKYCRequestTabProps) {
            ...
            <Grid item md={4} xs={12}>
              <Stack direction="column" spacing={1}>
                ...
                <Typography variant="subtitle2">
                  {DateConvert.stringToDateFormat(new Date(), LONG_DATE_FORMAT)}{' '}
                  -{' '}
                  {DateConvert.stringToDateFormat(new Date(), LONG_DATE_FORMAT)}
                </Typography>
                <Divider />
