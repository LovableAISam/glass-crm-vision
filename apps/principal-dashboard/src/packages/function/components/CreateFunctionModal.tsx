...
const CreateFunctionModal = (props: CreateFunctionModalProps) => {
  ...
  const handleSave = () => {
    enqueueSnackbar(tCommon('successAdd', { text: 'Function' }), {
      variant: 'success',
    });
    onHide();
  }
    ...
    >
      <DialogTitle>
        <Stack direction="row" justifyContent="space-between" alignItems="center">
          <Typography variant="h5">Add Function</Typography>
      ...
      <DialogContent>
        <Grid container spacing={2} sx={{ pt: 1 }}>
          <Grid item md={12} xs={12}>
            <Typography variant="subtitle2" gutterBottom>Function Code</Typography>
            <TextField
              fullWidth
              placeholder="type function code"
              sx={{
          ...
          <Grid item md={12} xs={12}>
            <Typography variant="subtitle2" gutterBottom>Function Name</Typography>
            <TextField
              fullWidth
